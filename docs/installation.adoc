...
Check that Infinispan nodes have successfully formed clusters.
...
The response indicates that Infinispan nodes have received clustered views, as in the following example:
